      ...
      <div className="page-wrap">
        ...
        {!lance.loading && !lance.error && !selectedMember && (
          <>
            ...
            {activeTab === 'covens' && <CovensTab data={lance.data} isAdmin={isAdmin} onUpsert={lance.upsertCoven} onDelete={lance.deleteCoven} onUpsertRitual={lance.upsertCovenRitual} onDeleteRitual={lance.deleteCovenRitual} onUpdateMana={lance.updateCovenMana} />}
